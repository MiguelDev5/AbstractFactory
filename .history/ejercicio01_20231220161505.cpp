...
public:
    void prepareIngredients() { ingredientes = "Pasta, Tomato Sauce, Parmesan Cheese"; };
...
public:
    void prepareIngredients() { ingredientes = "Tortillas, Ground Beef, Lettuce, Tomatoes, Cheese, Salsa"; };
...
public:
    void prepareIngredients() { ingredientes = "Chicken, Vegetables, Soy Sauce, Ginger, Garlic"; };
