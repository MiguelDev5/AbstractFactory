...
// Usage
int main() {
    cocinaPeruanaFactory peruFactory;
    cocinaMexicanaFactory mexicoFactory;

    Cook cook;

    cout << "Cocina Peruana:" << endl;
    cook.prepararComida(peruFactory);

    cout << "\Cocina Méxicana:" << endl;
    cook.prepararComida(mexicoFactory);
